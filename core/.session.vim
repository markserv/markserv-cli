...
silent only
cd ~/ms/markserv-cli/core
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 ~/ms/markserv-cli/Markconf.js
badd +15 ~/ms/markserv-cli/core/markserv.js
badd +0 ~/ms/markserv-cli/core/help.fs.js
argglobal
silent! argdel *
edit ~/ms/markserv-cli/core/help.fs.js
