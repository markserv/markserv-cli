...
module.exports = (name, modulePath, ModifierModule, initFunction, markserv) => { // eslint-disable-line max-params
	...
	let httpResponseModifier;

	if (typeof pluginDef.helpers === 'function') {
		console.log(1111111111111111111111);
		pluginDef.helpers = pluginDef.helpers(ModifierModule.exports, markserv);
		console.log(pluginDef.helpers);
		httpResponseModifier = pluginDef.handle(exports, pluginDef.helpers);
	} else {
		httpResponseModifier = pluginDef.handle(exports);
	}


	exports.httpResponseModifier = httpResponseModifier;
