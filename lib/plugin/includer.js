...
module.exports = (name, modulePath, ModifierModule, initFunction, markserv, Markconf) => { // eslint-disable-line max-params
	...
	const htmlCommentIncluder = initFunction(exports, markserv, exports, Markconf);
