...
module.exports = config => props => {
	...
	exports.configTemplate = undefined;
	exports.configTemplateUrl = undefined;
	...
	const loadTemplate = (url, type) => new Promise((resolve, reject) => {
		config.compiler.compileTemplate(url, exports)
		.then(html => {
