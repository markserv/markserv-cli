...
const init = () => {
	...
	const isUrl = parts => {
		...
		const startsWithUrl = !patterns.some(pattern => dirname.indexOf(pattern) === 0)
		console.log(startsWithUrl, includer)

		return startsWithUrl || includer === 'http'
	}
