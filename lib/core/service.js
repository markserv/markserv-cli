...
const plugin = require('app/plugin/register');
const help = require('app/help/plugins');

const httpRequestHandler = require('app/http/requests');
const httpServer = require('app/http/server');
const templateCompiler = require('app/http/compiler');

require('app/core/shutdown')(process);
